...
import 'package:cms_ibpr/module/account_type/account_type_notifier.dart';
...
class AccountTypePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AccountTypeNotifier(context: context),
      child: Consumer<AccountTypeNotifier>(
          ...
          body: Column(
            ...
            children: [
              ...
              Expanded(
                ...
                onRefresh: () => value.getAccountType(),
                child: ListView(
                  children: [
                    value.isLoading
                        ? Container(
...
class DetailDataSource extends DataGridSource {
  DetailDataSource(List<AcctTypeModel> list) {
    int index = 1;
    _laporanData = list.map<DataGridRow>((data) {
      DataGridRow row = DataGridRow(
        cells: [
          DataGridCell(columnName: 'no', value: index.toString()),
          DataGridCell(columnName: 'kd_acc', value: data.kdAcc),
