...
class BlokirNasabahPage extends StatelessWidget {
  const BlokirNasabahPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => BlokirNasabahNotifier(context: context),
      child: Consumer<BlokirNasabahNotifier>(
