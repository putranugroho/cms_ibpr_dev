    ...
    _laporanData = list.map<DataGridRow>((data) {
      DataGridRow row = DataGridRow(
        cells: [
          ...
          DataGridCell(columnName: 'tarik_tunai', value: data.trkTunaiTrx),
          DataGridCell(columnName: 'setor_tunai', value: data.setorTrx),
          DataGridCell(columnName: 'transfer', value: data.trfTrx),
          DataGridCell(columnName: 'ppob', value: data.ppobTrx),
          DataGridCell(columnName: 'qr', value: data.qrTrx),
